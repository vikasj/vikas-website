                ...
                <div class = "navbar navbar-inverse navbar-fixed-top">
                        <div class = "container">
                                ...
                                <div class = "collapse navbar-collapse navHeaderCollapse">
                                        <ul class = "nav navbar-nav navbar-right">
                                                <li class = "active"><a href = "home.php" id="scale">Home</a></li>
                                                <li><a href = "resume.php" id="scale">Resume</a></li>
                    ...
                    <div class = "container">
                        <div class="row">
                           ...
                           <div class = "jumbotron">
							 <h1>Vikas Joshi</h1>
                                <p>One of my goals in life is to play an important role in the creation of new innovative software that will have a significant impact on the technological advancements of our society. As a student at the University of Waterloo pursuing a Bachelor's degree in Computer Science, programming is definitely my passion. I'm highly dedicated to the work I do and very eager to learn.  My interests include software development, web design, and android development. Please have a look at my <a href="resume.pdf"><b>resume</b></a> and email me if you're looking to hire a developer or have any questions.</p>
							    <p>
